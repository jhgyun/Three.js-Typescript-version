...
namespace THREE
{
    export class Matrix4
    {
        ...
        extractRotation(m: Matrix4): this
        {
            ...
            var func = Matrix4.prototype.extractRotation = function (m: Matrix4)
            {
                var te = this.elements;
                var me = m.elements;
        ...
        { 
            ...
            var func = Matrix4.prototype.lookAt = function (eye: Vector3, target: Vector3, up: Vector3)
            {
                var te = this.elements;
        ...
        multiplyToArray(a: Matrix4, b: Matrix4, r: ArrayLike<number>)
        { 
            var te = this.elements; 
        ...
        applyToVector3Array(array: ArrayLike<number>, offset?: number, length?: number): ArrayLike<number>
        {
            ...
            var func = Matrix4.prototype.applyToVector3Array = function (array: ArrayLike<number>, offset: number = 0, length = array.length)
            {
        ...
        applyToBuffer(buffer: Buffer, offset?:number, length?: number): Buffer
        {
            ...
            var func = Matrix4.prototype.applyToBuffer = function (buffer: Buffer, offset = 0, length = buffer.length / buffer.itemSize)
            {
        ...
        decompose(position: Vector3, quaternion: Quaternion, scale: Vector3): this
        {
            ...
            var func = Matrix4.prototype.decompose
                = function (position: Vector3, quaternion: Quaternion, scale: Vector3)
            {
                var te = this.elements;
