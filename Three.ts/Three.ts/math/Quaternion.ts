...
namespace THREE
{
    ...
    {
        constructor(private _x = 0, private _y = 0, private _z = 0, private _w = 1)
        {
        }
        get x()
        {
        ...
        static slerpFlat(dst: ArrayLike<number>, dstOffset: number,
            src0: ArrayLike<number>, srcOffset0: number,
            src1: ArrayLike<number>, srcOffset1: number, t: number)
        {
