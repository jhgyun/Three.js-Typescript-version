...
{ 
    export class Geometry extends EventDispatcher implements IGeometry
    {
        ...
        rotateX(angle: number)
        {
            ...
            var m1: Matrix4 = Geometry[".rotateX.m1"] || (Geometry[".rotateX.m1"] = new Matrix4());
        ...
        rotateY(angle: number)
        {
            ...
            var m1: Matrix4 = Geometry[".rotateY.m1"] || (Geometry[".rotateY.m1"] = new Matrix4());
        ...
        rotateZ(angle: number)
        {
            ...
            var m1: Matrix4 = Geometry[".rotateZ.m1"] || (Geometry[".rotateZ.m1"] = new Matrix4());
        ...
        {
            // translate geometry  
            var m1: Matrix4 = Geometry[".translate.m1"] || (Geometry[".translate.m1"] = new Matrix4());
        ...
        {
            // scale geometry  
            var m1: Matrix4 = Geometry[".scale.m1"] || (Geometry[".scale.m1"] = new Matrix4());
        ...
        fromBufferGeometry(geometry: BufferGeometry)
        {
            ...
            var addFace = (a: number, b: number, c: number, materialIndex?: number) =>
            {
        ...
        mergeMesh(mesh: Mesh)
        {
            ...
            this.merge(mesh.geometry as Geometry, mesh.matrix);
        }
