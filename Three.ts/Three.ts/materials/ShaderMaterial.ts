...
namespace THREE
{
    export interface ShaderMaterialParams extends IMaterialParams
    {
        defines?: any; // { "label" ?: number ; // "value" },
        uniforms?: any; // { "parameter1"?: number ; // { value?: number ; // 1.0 }, "parameter2"?: number ; // { value2?: number ; // 2 } },
