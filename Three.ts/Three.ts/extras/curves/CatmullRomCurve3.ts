...
namespace THREE
{
    ...
    export class CatmullRomCurve3 extends Curve<Vector3>
    {
        ...
        constructor(p?: Vector3[] /* array of Vector3 */)
        {
            super();
            this.points = p || [];
            this.closed = false; 
        ...
        private static tmp  :Vector3 ;
        private static px   :CubicPoly ;
        private static py   :CubicPoly ;
        private static pz   :CubicPoly ;
        ...
        { 
            ...
            if (tmp == undefined)
            {
                tmp = CatmullRomCurve3.tmp = new Vector3();
