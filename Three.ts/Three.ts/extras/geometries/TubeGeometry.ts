...
namespace THREE
{
    export class TubeGeometry extends Geometry
    {
        ...
        constructor(path, segments, radius, radialSegments, closed, taper)
        { 
            super();
        ...
        static NoTaper = function (u)
        { 
            return 1; 
        };

        static SinusoidalTaper = function (u)
        { 
            return Math.sin(Math.PI * u); 
        };

        // For computing of Frenet frames, exposing the tangents, normals and binormals the spline
        static FrenetFrames = function (path, segments, closed)
        { 
            ...
            */
            ...
            if (closed)
            {
                ...
                theta = Math.acos(Math.clamp(normals[0].dot(normals[numpoints - 1]), - 1, 1));
                theta /= (numpoints - 1);
